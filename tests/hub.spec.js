...
test('hub shows the six sections', async ({ page }) => {
  ...
  await expect(page.locator('#hub-tasks-btn')).toContainText('Tasks');
});
...
const routes = [
  ...
  { name: 'Tasks', open: '#hub-tasks-btn', screen: 'tasks-screen', back: '#tasks-back-btn' },
];
